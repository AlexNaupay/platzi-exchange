      ...
      <div class="flex flex-col sm:flex-row justify-around items-center">
        ...
        <div class="my-10 flex flex-col">
          <ul>
            ...
            <li class="flex justify-between">
              <b class="text-gray-600 mr-10 uppercase">Change % 24hs</b>
        ...
        <div class="my-10 sm:mt-0 flex flex-col justify-center text-center">
          ...
          <div class="flex flex-row my-5">
            <label class="w-full" for="convertedValue">
              <input v-model="convertedValue" id="convertedValue" type="number"
...
export default {
  ...
  computed: {
    convertedResult() {
      ...
      const result = this.fromUsd ? this.convertedValue / this.asset.priceUsd
